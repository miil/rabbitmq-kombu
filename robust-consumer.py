...
queue = Queue(name=s.Q_NAME, exchange=exchange, routing_key="BOB")
...
def establish_connection():
    ...
    revived_connection.ensure_connection(max_retries=100)
...
def consume():
    ...
    while True:
        try:
            new_conn.drain_events(timeout=12)
